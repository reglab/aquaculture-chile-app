...
pages = {
    "Data Exploration": [
        ...
        st.Page('pages/page2_sensors.py', title="Sensors Exploration"),
        st.Page('pages/page3_production.py', title="Production Exploration"),
        st.Page('pages/page3b_production_movement.py', title="Ownership and Production Trends Exploration"),
        st.Page('pages/page4_environmental.py', title="Environmental Impacts Exploration")
